...
import { TrainingReviewsContent } from "../training_components/TrainingReviewsContent";

export const Training = () => {
  return (
    <>
      <PageHero bgImage="bg-training-banner" pageHeader="Training"></PageHero>
